...
extension CGFloat {
    ...
    static var verticleInsets: Double{
        if let keyWindow = UIApplication.shared.keyWindow{
...
extension View {
    ...
    var verticle18: some View {
        return padding(.vertical, 18)
    }

    var horizontal18: some View {
        return padding(.horizontal, 18)
    }
    
    var verticle15: some View {
    ...
    var bottomWithSafe: some View {
        return padding(.bottom, .topInsets + 8)
    }
}
